      ...
      <div className="max-w-3xl w-full bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-slate-100">
        ...
        <section className="space-y-6 text-center">
          ...
          <blockquote className="border-l-4 border-blue-200 pl-6 py-2 text-left text-slate-600 italic">
            "No necesitas ver toda la escalera para dar el primer paso. Aquí, tu voz es privada, tu proceso es protegido y tu bienestar es nuestra única brújula."
          </blockquote>
        </section>

        {/* Pilares de Confianza (Tus Principios) */}
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          <div className="p-4 bg-blue-50 rounded-lg">
            <h3 className="font-semibold text-blue-900 mb-2">Privacidad Absoluta</h3>
            <p className="text-sm text-blue-800/80">Palabras blindadas con cifrado de grado médico.</p>
          </div>
          <div className="p-4 bg-green-50 rounded-lg">
            <h3 className="font-semibold text-green-900 mb-2">Seguridad 24/7</h3>
            <p className="text-sm text-green-800/80">Crisis Guard activo para proteger tu integridad.</p>
          </div>
          <div className="p-4 bg-purple-50 rounded-lg">
            <h3 className="font-semibold text-purple-900 mb-2">Ética Humana</h3>
            <p className="text-sm text-purple-800/80">Transparencia total en el manejo de tu información.</p>
          </div>
        </div>

        {/* Acción Principal */}
        <div className="mt-12 text-center">
          <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-10 rounded-full transition-all transform hover:scale-105 shadow-lg">
